...
// "INVEGA SUSTENNA® Monthly Maintenance Dosing" 3rd Panel on /conversionguide1 page
export default function PanelC() {
  const { t } = useTranslation();
  // enFr is the language swapping helper and mg ensures that all mg values are non-breaking with units
    ...
    <article className="maintenance">
      <div className="width-80p m-0-auto">
        ...
        <section className="maintenance">
          {/* "Monthly - Deltoid or Gluteal" label */}
          ...
          {/* "Maintenance Dose for Schizophrenia" dosing card figure */}
          ...
          {/* "Maintenance Dose for Schizoaffective Disorder" dosing card figure */}
